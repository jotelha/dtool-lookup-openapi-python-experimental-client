...
# body param
SchemaForRequestBodyApplicationJson = RegisterDataset


request_body_register_dataset = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Uri
...
class DatasetRegisterPost(api_client.Api):
    ...
    def dataset_register_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_register_dataset.serialize(body, content_type)
