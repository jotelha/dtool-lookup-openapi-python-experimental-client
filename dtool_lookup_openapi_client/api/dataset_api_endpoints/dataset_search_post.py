...
# body param
SchemaForRequestBodyApplicationJson = SearchDataset


request_body_search_dataset = api_client.RequestBody(
    content={
...
class DatasetSearchPost(api_client.Api):
    ...
    def dataset_search_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_search_dataset.serialize(body, content_type)
