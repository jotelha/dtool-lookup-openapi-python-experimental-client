...
# body param
SchemaForRequestBodyApplicationJson = Uri


request_body_uri = api_client.RequestBody(
    content={
...
class DatasetAnnotationsPost(api_client.Api):
    ...
    def dataset_annotations_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_uri.serialize(body, content_type)
