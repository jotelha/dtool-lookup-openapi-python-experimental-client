...
class SchemaForRequestBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['RegisterUser']:
        return RegisterUser


request_body_register_user = api_client.RequestBody(
    content={
...
class AdminUserRegisterPost(api_client.Api):
    ...
    def admin_user_register_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_register_user.serialize(body, content_type)
