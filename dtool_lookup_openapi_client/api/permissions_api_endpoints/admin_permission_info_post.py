...
# body param
SchemaForRequestBodyApplicationJson = BaseUri


request_body_base_uri = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UriPermission
...
class AdminPermissionInfoPost(api_client.Api):
    ...
    def admin_permission_info_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_base_uri.serialize(body, content_type)
