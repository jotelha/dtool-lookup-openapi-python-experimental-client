...
# body param
SchemaForRequestBodyApplicationJson = UriPermission


request_body_uri_permission = api_client.RequestBody(
    content={
...
_path = '/admin/permission/update_on_base_uri'
_method = 'POST'
_auth = [
    'bearerAuth',
]
...
class AdminPermissionUpdateOnBaseUriPost(api_client.Api):
    ...
    def admin_permission_update_on_base_uri_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_uri_permission.serialize(body, content_type)
